...
export default function CreateAd() {
  ...
  function handleCreateBook() {
    BookApi.createBook(title, description, location, genres, image, localStorage.getItem("userId"))
  }
  ...
  return (
    <main>
      <form className="createAd_form">
        ...
        <button onClick={()=>handleCreateBook()} className="createAd_button">Post</button>
      </form>
    </main>
  );
}
